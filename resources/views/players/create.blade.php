...
@section('content')
    <div class="mt-5">
        <h3 class="fs-3 fw-semibold mt-2">Create player</h3>
    </div>
    <div class="mt-2 bg-white dark:bg-gray-800 rounded-lg shadow divide-y divide-gray-100 dark:divide-gray-700">
        <form action="{{ route('players.store') }}" method="POST" enctype="multipart/form-data" class="bg-white px-5 py-3 border-gray-100 border-2 rounded-lg">
            @csrf
            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-md-8 col-sm-12 p-3">
                    <select class="form-select" id="teamSelect" aria-label="Select team" name="team_id">
                        <option selected>Assign to team</option>
            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-md-8 col-sm-12 p-3">
                    <input type="email" name="user[email]" id="email" class="form-control" autocomplete="off">
                </div>
            </div>
            ...
            <div class="row g-3 align-items-center">
                <div class="col-md-4 col-sm-12 p-3">
                    <label for="cover-photo" class="form-label">Photo</label>
                </div>
                <div class="col-md-8 col-sm-12 p-3">

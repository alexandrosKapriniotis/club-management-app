...
@section('content')
    <div class="mt-5">
        <h3 class="fs-3 fw-semibold mt-2">Player: {{ $player->name }}</h3>
    </div>
    <div class="p-3 mt-2 bg-white dark:bg-gray-800 rounded-lg shadow divide-y divide-gray-100 dark:divide-gray-700">
        ...
        <div class="row g-3 align-items-center">
            <div class="col-md-4 col-sm-12 p-3">
                <p class="form-label fw-semibold">Player name</p>
            </div>
        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-8 col-sm-12 p-3">
                <p class="form-control">{{$player->description}}</p>
            </div>
        </div>

        <div class="row g-3 align-items-center">
            <div class="col-md-4 col-sm-12 p-3">
                <p class="form-label fw-semibold">Team</p>
            </div>
            <div class="col-md-8 col-sm-12 p-3">
                <p class="form-control">{{$player->team->name}}</p>
            </div>
        </div>

        <div class="row g-3 align-items-center">
            <div class="col-md-4 col-sm-12 p-3">
                <p class="form-label fw-semibold">Photo</p>
            </div>
            <div class="col-md-8 col-sm-12 p-3">
